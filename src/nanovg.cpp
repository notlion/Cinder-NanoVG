...
Context Context::create(NVGcontext *ptr, Deleter deleter) {
  return { ptr, deleter };
}
...
void Context::save() { nvgSave(get()); }
void Context::restore() { nvgRestore(get()); }
void Context::reset() { nvgReset(get()); }
...
void Context::miterLimit(float limit) { nvgMiterLimit(get(), limit); }
void Context::strokeWidth(float size) { nvgStrokeWidth(get(), size); }
void Context::lineCap(int cap) { nvgLineCap(get(), cap); }
void Context::lineJoin(int join) { nvgLineJoin(get(), join); }
...
void Context::rotate(float angle) { nvgRotate(get(), angle); }
void Context::skewX(float angle) { nvgSkewX(get(), angle); }
void Context::skewY(float angle) { nvgSkewY(get(), angle); }
void Context::scale(float x, float y) { nvgScale(get(), x, y); }
void Context::scale(const vec2 &s) { scale(s.x, s.y); }
...
void Context::beginPath() { nvgBeginPath(get()); }
void Context::moveTo(float x, float y) { nvgMoveTo(get(), x, y); }
void Context::moveTo(const vec2 &p) { moveTo(p.x, p.y); }
void Context::lineTo(float x, float y) { nvgLineTo(get(), x, y); }
void Context::lineTo(const vec2 &p) { lineTo(p.x, p.y); }
...
void Context::closePath() { nvgClosePath(get()); }
void Context::pathWinding(int dir) { nvgPathWinding(get(), dir); }
...
void Context::fill() { nvgFill(get()); }
void Context::stroke() { nvgStroke(get()); }
...
void Context::fontSize(float size) { nvgFontSize(get(), size); }
void Context::fontBlur(float blur) { nvgFontBlur(get(), blur); }
void Context::fontFaceId(int font) { nvgFontFaceId(get(), font); }
void Context::fontFace(const std::string& font) { nvgFontFace(get(), font.c_str()); }
